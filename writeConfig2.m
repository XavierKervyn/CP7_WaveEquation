...
fprintf(fid,['output_mesh= Nsteps_',num2str(N_loc),'_mesh.out\n']); 
fprintf(fid,['output_file= Nsteps_',num2str(N_loc),'_f.out\n']); 
fprintf(fid,['output_energy= Nsteps_',num2str(N_loc),'_E.out\n']); 
fprintf(fid,['output_velocity= Nsteps_',num2str(N_loc),'_u.out\n']);
