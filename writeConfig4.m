...
fprintf(fid,['tfin=', num2str(tfin,8),'\n']);
...
fprintf(fid,['pert_velocity=', num2str(PV_loc),'\n']);
...
fprintf(fid,['dt=', num2str(dt,8),'\n']);
fprintf(fid,['CFL=', num2str(CFL,8),'\n']);
...
fprintf(fid,['output_mesh= PVelocity_',num2str(PV_loc),'_mesh.out\n']); 
fprintf(fid,['output_file= PVelocity_',num2str(PV_loc),'_f.out\n']); 
fprintf(fid,['output_energy= PVelocity_',num2str(PV_loc),'_E.out\n']); 
fprintf(fid,['output_velocity= PVelocity_',num2str(PV_loc),'_u.out\n']);
