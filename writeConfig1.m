...
fprintf(fid,['output_mesh=',fname_loc,'_mesh.out\n']); 
fprintf(fid,['output_file=',fname_loc,'_f.out\n']); 
fprintf(fid,['output_energy=',fname_loc,'_E.out\n']); 
fprintf(fid,['output_velocity=',fname_loc,'_u.out\n']);
